...
#include <math.h>
#include "../include/rubikprocessor/internal/RubikProcessorImpl.hpp"
#include "opencv2/highgui/highgui.hpp"
#include "opencv2/imgproc/imgproc.hpp"
#include "opencv2/imgproc/imgproc_c.h"
#include "../include/utils/Utils.hpp"
#include "../include/utils/CrossLog.hpp"
#include "../include/data/config/ImageProperties.hpp"
...
/**##### PRIVATE MEMBERS FROM HERE #####**/
    ...
    const std::vector<RubikFacelet> RubikProcessorImpl::findCubeInternal(
            const uint8_t *imageData) {
...
//            only calculate frame rate if the processor is debuggable
        ...
        const std::vector<RubikFacelet> facelets = faceletsDetector->detect(
                processingFrameGrey,
                frameNumber);
        if (facelets.size() != 0) {
            if (isDebuggable()) {
